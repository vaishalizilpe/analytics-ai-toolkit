...
with tab_drill:
    ...
    st.markdown(
        "Write your own answers first, then generate the model answer and compare. "
...
""")
    ...
    your_answer = st.text_area(
        ...
        height=200, key="drill_your_answer",
    )
    generate_clicked = st.button(f"Generate model answer for {drill_product}", type="primary", key="drill_generate")
